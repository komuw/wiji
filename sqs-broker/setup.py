...
about = {}
with open(os.path.join(here, "wijiSQSbroker", "__version__.py"), "r") as f:
    x = f.read()
    y = x.replace("about = ", "")
...
setup(
    ...
    keywords="wijiSQSbroker, blah",
    # You can just specify the packages manually here if your project is
    # simple. Or you can use find_packages().
    # packages=['wijiSQSbroker'],
    ...
    install_requires=["botocore==1.12.111"],
    ...
    #     ],
    # },
    entry_points={"console_scripts": ["wijiSQSbroker-cli=cli.cli:main"]},
)
